...
from myutils import imresize, convert, match_hist
...
def get_morfologia(pick):
    ...
    x_centro = int(l / 2)
    y_centro = int(c / 2)
    pick = imresize(pick, (l, c), interp='bilinear')
        ...
        for jll in range(0, int(stepcc * frames), stepcc):
            ...
            if sim < 0.8:
                ...
                if alg == 1:
                    ...
                    sub_templateg = exposure.adjust_sigmoid(sub_templateg)
            ...
            for segmentoAtual in regions:
                ...
                if ar_seg >= minseg and ar_seg < maxseg:
                    ...
                    if per_seg > 0:
                        ...
                        # ptem = imresize(sub_templateg[xi:xf, yi:yf] * pv, (32, 32), interp='bilinear')
                        # plt.figure('pick')
                        # plt.imshow(ptem, cmap='gray')
                        # plt.show()
